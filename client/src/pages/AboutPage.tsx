  ...
  return (
    <section className="mx-auto w-full max-w-2xl">
      <header className="mb-6 text-center">
        <h1 className="text-xl sm:text-2xl font-semibold">About</h1>
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
          Learn more about this project and what powers it.
        </p>
      </header>

      <article className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm p-4 sm:p-6">
        <p className="text-base sm:text-lg">Welcome to the About Page 📖</p>

        <section className="mt-6">
          <h2 className="text-lg sm:text-xl font-semibold">What is Chat‑UI?</h2>
